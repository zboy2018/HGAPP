<template>
  <div>
    ...
    <div style="padding:15px;">
      <x-button type="primary" plain @click.native="showPlugin">124</x-button>
    </div>

    <group title="YYYYMMDD">
      <datetime
        v-model="value1"
        @on-change="change"
        title="grre"
    ...
    <group title="aaaa">
      <datetime v-model="minuteListValue" format="YYYY-MM-DD HH:mm" :minute-list="['00', '15', '30', '45']" @on-change="change" title="greg"></datetime>
    </group>
    <group title="weg">
      <datetime v-model="value8" :title="tewt" clear-text="clear" @on-clear="clearValue8" :required="true"></datetime>
    </group>

    <group title="rewrwr">
      <datetime v-model="value9" @on-change="change" title="rrrr" :show.sync="visibility"></datetime>
    </group>
